...
public class DateUtil2 {
	...
	public LocalDate toLocalDate(String strDate) {
		...
		try {
			...
			result = LocalDate.parse(strDate, formatter);
	 ...
	 * 
	 * @param strDate	요일을 구할 날짜
	 * @return			요일
	*/
	public String toDayOfWeek(String strDate) {
		String result = null;

		try {
			LocalDate localDate = toLocalDate(strDate);
	 ...
	 * 
	 * @param strDate	일자를 구할 날짜
	 * @return			일자
	*/
	public int dayOfTheYear(String strDate) {
		int result = 0;
	 ...
	 * 
	 * @param strDate	주차를 구할 날짜
	 * @return			주차
	*/
	public int weekOfTheYear(String strDate) {
		int result = 0;
